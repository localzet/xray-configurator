import {InboundConfig, JsonValue, randomBase64Url, randomHex, randomToken, XrayConfig} from './xray';
        ...
        create: () => baseServerConfig({
            ...
            streamSettings: {
                ...
                tlsSettings: {
                    ...
                    alpn: ['h2', 'http/1.1'],
                    certificates: [{
                        certificateFile: '/etc/ssl/example.com/fullchain.pem',
            ...
            inbounds: [
                ...
                },
                {
                    ...
                    streamSettings: {
                        network: 'ws',
                        security: 'none',
                        wsSettings: {path: '/ws', acceptProxyProtocol: true}
                    },
                },
                {
...
function certificateSettings(serverName: string): NonNullable<InboundConfig['streamSettings']>['tlsSettings'] {
    return {
        ...
        alpn: ['h2', 'http/1.1'],
        certificates: [{
            certificateFile: `/etc/ssl/${serverName}/fullchain.pem`,
            keyFile: `/etc/ssl/${serverName}/privkey.pem`
        }],
    };
}
